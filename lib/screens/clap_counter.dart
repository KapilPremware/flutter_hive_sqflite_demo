...
class ClapCounter extends StatefulWidget {
  ClapCounter({Key key, this.title}) : super(key: key);
  final String title;

  @override
  ClapCounterState createState() => new ClapCounterState();
}
...
class ClapCounterState extends State<ClapCounter> with TickerProviderStateMixin {
  int _counter = 0;
  ...
  Widget getClapButton() {
    ...
    return new GestureDetector(
        ...
        child: new Container(
          ...
          child: new ImageIcon(
              new AssetImage("assets/images/clap.png"), color: Colors.pink,
              size: 40.0),
        )
    );
  }
